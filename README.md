...
- **WhatsApp**: Twilio Sandbox como canal recomendado para iniciar (alternativa: Meta WhatsApp Cloud API). Adaptador `mock` disponible para desarrollo sin canal real.
...
- Selector de proveedor de WhatsApp: `mock | twilio | meta`. `mock` no envía mensajes reales, útil para desarrollar sin canal configurado.
