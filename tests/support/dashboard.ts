...
export function patient(id: string, name: string, level: DashboardPatient["risk"]["level"] = "unknown"): DashboardPatient {
  return {
    ...
    whatsappE164: "+525500000000", diagnoses: [], diagnosisCodes: [], diagnosedOn: {}, complicationCodes: null, consentGranted: false, lastResponseAt: null,
    diabetesTreatmentPhase: null, hypertensionTreatmentPhase: null,
